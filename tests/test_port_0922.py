...
class PortSourceTests(unittest.TestCase):
    ...
    def test_release_version_metadata_is_aligned(self):
        ...
        self.assertEqual('0.9.2', packager.MOD_VERSION)
        ...
        for directory in ('launcher', 'server'):
            ...
            self.assertIn("StringStruct('FileVersion', '0.9.2')", source)
            self.assertIn("StringStruct('ProductVersion', '0.9.2')", source)
            self.assertIn('filevers=(0, 9, 2, 0)', source)
            self.assertIn('prodvers=(0, 9, 2, 0)', source)
    ...
    def test_copy_ready_overlay_always_contains_loopback_endpoint(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual('0.9.2', identity['semanticVersion'])
            self.assertRegex(
